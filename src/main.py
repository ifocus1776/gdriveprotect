...
from src.routes.dlp_scanner import dlp_bp
from src.routes.drive_monitor import drive_bp
from src.routes.vault_manager import vault_bp
...
def health_check():
    ...
    return {'status': 'healthy', 'message': 'GDriveProtect is running'}
